...
import com.star1xr.treelauncher.viewmodel.VulkanDriverDownloadState
import com.star1xr.treelauncher.viewmodel.VulkanDriverViewModel
...
fun VulkanDriverDownloaderScreen(
    ...
    var deleteConfirmRelease by remember { mutableStateOf<com.star1xr.treelauncher.game.plugin.driver.GitHubRelease?>(null) }
...
private fun ReleaseItem(
    release: com.star1xr.treelauncher.game.plugin.driver.GitHubRelease,
    isInstalled: Boolean,
    onDownload: (com.star1xr.treelauncher.game.plugin.driver.GitHubAsset) -> Unit,
    onDelete: () -> Unit
) {
    Surface(
