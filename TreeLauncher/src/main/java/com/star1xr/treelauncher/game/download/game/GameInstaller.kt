...
package com.star1xr.treelauncher.game.download.game

import android.content.Context
import android.content.Intent
import com.star1xr.treelauncher.R
import com.star1xr.treelauncher.context.GlobalContext
import com.star1xr.treelauncher.coroutine.Task
import com.star1xr.treelauncher.coroutine.TaskFlowExecutor
import com.star1xr.treelauncher.coroutine.TitledTask
import com.star1xr.treelauncher.coroutine.addTask
import com.star1xr.treelauncher.coroutine.buildPhase
import com.star1xr.treelauncher.game.addons.mirror.mapBMCLMirrorUrls
import com.star1xr.treelauncher.game.addons.modloader.ModLoader
import com.star1xr.treelauncher.game.addons.modloader.cleanroom.CleanroomVersion
import com.star1xr.treelauncher.game.addons.modloader.fabriclike.FabricLikeVersion
import com.star1xr.treelauncher.game.addons.modloader.forgelike.ForgeLikeVersion
import com.star1xr.treelauncher.game.addons.modloader.forgelike.neoforge.NeoForgeVersion
import com.star1xr.treelauncher.game.addons.modloader.modlike.ModVersion
import com.star1xr.treelauncher.game.download.assets.platform.mcim.mapMCIMMirrorUrls
import com.star1xr.treelauncher.game.download.game.cleanroom.getCleanroomDownloadTask
import com.star1xr.treelauncher.game.download.game.cleanroom.targetTempCleanroomInstaller
import com.star1xr.treelauncher.game.download.game.fabric.getFabricLikeCompleterTask
import com.star1xr.treelauncher.game.download.game.fabric.getFabricLikeDownloadTask
import com.star1xr.treelauncher.game.download.game.forge.getForgeLikeAnalyseTask
import com.star1xr.treelauncher.game.download.game.forge.getForgeLikeDownloadTask
import com.star1xr.treelauncher.game.download.game.forge.getForgeLikeInstallTask
import com.star1xr.treelauncher.game.download.game.forge.isNeoForge
import com.star1xr.treelauncher.game.download.game.forge.targetTempForgeLikeInstaller
import com.star1xr.treelauncher.game.download.game.optifine.getOptiFineDownloadTask
import com.star1xr.treelauncher.game.download.game.optifine.getOptiFineInstallTask
import com.star1xr.treelauncher.game.download.game.optifine.getOptiFineModsDownloadTask
import com.star1xr.treelauncher.game.download.game.optifine.targetTempOptiFineInstaller
import com.star1xr.treelauncher.game.download.jvm_server.JVMSocketServer
import com.star1xr.treelauncher.game.download.jvm_server.JvmService
import com.star1xr.treelauncher.game.path.getGameHome
import com.star1xr.treelauncher.game.version.download.BaseMinecraftDownloader
import com.star1xr.treelauncher.game.version.download.MinecraftDownloader
import com.star1xr.treelauncher.game.version.installed.VersionConfig
import com.star1xr.treelauncher.game.version.installed.VersionFolders
import com.star1xr.treelauncher.game.version.installed.VersionsManager
import com.star1xr.treelauncher.path.PathManager
import com.star1xr.treelauncher.utils.file.copyDirectoryContents
import com.star1xr.treelauncher.utils.logging.Logger.lDebug
...
import com.star1xr.treelauncher.utils.network.downloadFromMirrorListSuspend
import com.star1xr.treelauncher.utils.network.withSpeedReport
